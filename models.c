...
void linear_regression_predict(char filename[200], float s, float c)
{
    ...
    do
    {
        ...
        {
        case (1):
            mean_squared_error("test_tvmarketing.csv", predictions, n);
            break;
        case (2):
            root_mean_squared_error("test_tvmarketing.csv", predictions, n);
            break;
        case (3):
            mean_absolute_error("test_tvmarketing.csv", predictions, n);
            break;
        case (4):
            break;
        default:
